# Blazor Viewer Server sample

Sample demonstrates how to make Blazor Server Application with GrapeCity ActiveReports Blazor Viewer using local report service and remote report service.
