# JS Viewer silent print ASP.NET Core sample

This sample demonstrates how we can print a report only click once JSViewer print button, without showing the print preview dialog.
